...
function FlipBookContent() {
  ...
  return (
    ...
    >
      ...
      {/* flip book container with entrance animation — xs height accounts for mobile nav bar (68px + safe area) */}
      <Box
        ref={containerRef}
        component={motion.div}
        initial={state.prefersReducedMotion ? false : { opacity: 0, scale: 0.95 }}
